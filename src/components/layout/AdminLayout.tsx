  ...
  const navItems = [
    {
      ...
      active: location.pathname === '/select' || location.pathname === '/hub',
    },
    {
      label: 'Property Listings',
      path: '/admin?tab=listings',
      icon: Building2,
      active: location.pathname === '/admin' && (!location.search || location.search.includes('tab=listings')),
    },
    {
      label: 'Creator Portfolios',
      path: '/admin?tab=portfolios',
      icon: Home,
      active: location.pathname === '/admin' && location.search.includes('tab=portfolios'),
    },
    {
      label: 'Create Property',
      path: '/create',
      icon: PlusCircle,
      active: location.pathname === '/create' || location.pathname === '/admin/new',
    },
    {
      label: 'Create Portfolio',
      path: '/portfolio/create',
      icon: Plus,
      active: location.pathname === '/portfolio/create',
    },
    {
      label: 'Sample Portfolio',
      path: '/portfolio/rishika-kapoor',
      icon: ExternalLink,
      external: true,
      active: false,
    },
