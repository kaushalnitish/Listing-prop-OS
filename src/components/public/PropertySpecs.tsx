    ...
    <div className="space-y-6 sm:space-y-8 w-full max-w-full">
      ...
      {!hideHeader && (
        <div className="rounded-2xl sm:rounded-3xl bg-white/75 backdrop-blur-md border border-stone-200/80 p-5 sm:p-8 lg:p-10 shadow-sm relative overflow-hidden space-y-4 w-full">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-normal tracking-tight text-stone-900 leading-[1.2] break-words">
            {title}
          </h1>
          ...
          <div className="pt-3 flex flex-wrap items-baseline gap-2.5 sm:gap-4 min-w-0 border-t border-stone-200/60">
            ...
            <span className="text-xl sm:text-2xl lg:text-3xl font-normal text-stone-900 tracking-tight whitespace-nowrap">
      ...
      {!hideDetails && (
        <>
          <div className="space-y-6 pt-2">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 border-b border-stone-200/80 pb-4">
              <div className="space-y-1 max-w-xl">
                <h2 className="text-[10px] sm:text-xs font-mono uppercase tracking-[0.2em] text-stone-500 font-normal">
                  PROPERTY DETAILS
                </h2>
                <p className="text-xl sm:text-2xl lg:text-3xl font-normal text-stone-900 tracking-tight leading-snug">
                  Every detail, designed for your comfort.
                </p>
              </div>
              <p className="text-xs sm:text-sm text-stone-500 font-normal leading-relaxed max-w-md">
            ...
            <div className="rounded-2xl sm:rounded-3xl bg-white/85 backdrop-blur-md border border-stone-200/80 p-5 sm:p-6 lg:p-8 shadow-sm relative overflow-hidden w-full max-w-full">
              <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 w-full">
                <div className="min-w-0 p-3.5 sm:p-4 rounded-xl bg-stone-50/60 border border-stone-200/50">
                  <p className="text-[10px] sm:text-xs font-mono uppercase tracking-[0.18em] text-stone-500 font-normal truncate">
                    Bedrooms
                  </p>
                  <p className="text-xl sm:text-2xl font-normal text-stone-900 mt-1 truncate">
                    {safeBedrooms}
                  </p>
                </div>
                ...
                <div className="min-w-0 p-3.5 sm:p-4 rounded-xl bg-stone-50/60 border border-stone-200/50">
                  ...
                  <p className="text-xl sm:text-2xl font-normal text-stone-900 mt-1 whitespace-nowrap">
                    {safeSqFt}{' '}
                    {safeSqFt !== '—' && (
                      <span className="text-xs text-stone-500 font-normal ml-1">sq ft</span>
                    )}
                  </p>
                </div>
                ...
                <div className="min-w-0 p-3.5 sm:p-4 rounded-xl bg-stone-50/60 border border-stone-200/50">
                  ...
                  <p className="text-sm sm:text-base font-normal text-stone-900 mt-1 leading-snug break-words">
                    {safePropertyType}
                  </p>
                </div>
              </div>
          ...
          {(hasYearBuilt || hasParking) && (
            <div className="rounded-xl sm:rounded-2xl bg-white/75 backdrop-blur-md border border-stone-200/80 p-4 sm:p-5 shadow-2xs flex flex-wrap items-center gap-6 text-xs sm:text-sm text-stone-700 font-mono font-normal tracking-wide w-full">
              {hasYearBuilt && (
